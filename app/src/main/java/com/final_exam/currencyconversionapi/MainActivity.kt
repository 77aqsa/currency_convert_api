package com.final_exam.currencyconversionapi
...
class MainActivity : AppCompatActivity() {
    ...
    private fun getApiResult() {
        if (et_firstConversion != null && et_firstConversion.text.isNotEmpty() && et_firstConversion.text.isNotBlank()) {
            ...
            var API = "https://freecurrencyapi.net/api/v2/latest?apikey=03a49ab0-68c6-11ec-8f6c-3dd03626f80e&base_currency=$baseCurrency"
            ...
            if (baseCurrency == convertedToCurrency) {
                ...
                GlobalScope.launch(Dispatchers.IO) {
                    ...
                    try {
                        ...
                        conversionRate =
                            jsonObject.getJSONObject("data").getString(convertedToCurrency)
                                .toFloat()
